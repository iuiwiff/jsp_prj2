...
<style type = "text/css">
	...
	background: #ffffff url('http://192.168.10.230/common/images/sist.png')	
	}
...
<div id="wrap">
	<div id="memberDiv">
	<a href="http://192.168.10.230/member/${ url }" class="memberLink"><c:out value="${ sessionScope.loginData.name }${ pageScope.title }"/></a>
	<a href="http://192.168.10.230/member/member_join_frm.jsp" class="memberLink">회원가입</a>
	<a href="http://192.168.10.230/board/board_list.jsp" class="memberLink">게시판</a>
	</div>
</div>
</body>
</html>