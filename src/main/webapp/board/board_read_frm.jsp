...
$(function(){
    $("#btnList").click(function () {
        //history.back();
    	location.href="http://192.168.10.230/board/board_list.jsp?currentPage=${ param.currentPage }";
    });//click
...
<div id="boardContent">
	...
	<input type="hidden" name="currentPage" value="${ param.currentPage }"/>
	 ...
	 <tr>
	 	...
	 	<!-- 로그인한 사람이 작성자일 경우에만 글 수정, 삭제 가능 -->
	 	<c:if test="${ bVO.id eq sessionScope.loginData.id }">
