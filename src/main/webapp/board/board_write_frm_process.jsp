...
<c:if test="${ empty sessionScope.loginData }">
	<c:redirect url="http://192.168.10.230/index.jsp"/>
</c:if>
<!DOCTYPE html>
<html>
<head>
...
<!--  parameter 받기 -->
<jsp:useBean id="bVO" class="kr.co.sist.user.board.BoardDomain" scope="page"/>
...
<script type="text/javascript">
	...
	%>
	alert("글을 작성하였습니다.");
	location.href="http://192.168.10.230/board/board_list.jsp";
	<%
