...
<html lang="en" data-bs-theme="auto">
  <head><script src="http://192.168.10.230/js0404/js/color-modes.js"></script>
...
<!--jQuery CDN 끝-->
	...
	<script type="text/javascript">
		...
		function login() {
			//var param="id=" +$("#id").val()+"&pass="+$("#pass").val(); //query string
			var param={
					id : $("#id").val(),
					pass : $("#pass").val()
			};
			...
			$.ajax({
				...
				success : function(jsonObj) {
					//resultDiv
					if(jsonObj.result) {
						alert(jsonObj.name+"님 로그인하셨습니다.");
						location.href="ajax_call.jsp";
					}else{
						$("#resultDiv").html("<span style='color:#FF0000' id='msg'>아이디나 비밀번호를 확인해주세요</span>")
						for(var i=0; i<10; i++) {
							$("#msg").fadeOut(700).fadeIn(800);
						}
					}//end else
				}
			});//ajax
...
<main class="form-signin w-100 m-auto">
  <form name="frm" action ="login_process.jsp" method="post">
    ...
    <h1 class="h3 mb-3 fw-normal">이명화이자<br> 장원영 로그인</h1>
    ...
    <p class="mt-5 mb-3 text-body-secondary">&copy; ㅎㅎ</p>
  </form>
</main>
